            <div class="modal-header">
                <h5 class="modal-title" id="vista-modal-lLabel">Adicionar Cidade</h5>
            ...
            <form action="<?php echo $url; ?>city/save" id="vista-modal-form" method="post">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" value="" name="city" id="city" placeholder="Cidade...">
                    </div>
                </div>
            ...
            <script> 
                $(document).ready(function() { 
                    $('#vista-modal-form').ajaxForm(vistaAddCity);
                }); 
            </script>