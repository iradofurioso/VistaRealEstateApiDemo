            ...
            <form action="<?php echo $url; ?>neighborhood/save" id="vista-modal-form" method="post">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <select name="city" id="city" class="form-control" required="">
                            <?php 
                                ...
                                {
                                    $selected = ($neigh['fk_city_id'] == $city['id']) ? 'selected="selected"' : '';
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" value="<?php echo $neigh['name']; ?>" name="neighborhood" id="neighborhood" placeholder="Bairro...">
                    </div>
                </div>
            ...
            <script> 
                $(document).ready(function() { 
                    $('#vista-modal-form').ajaxForm(vistaEditNeighborhood);
                }); 
            </script>